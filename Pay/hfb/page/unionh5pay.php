		...
		<div class="col-md-6 col-md-offset-3">
			<form role="form" action="unionh5payhandler.php" method="post"  name="payForm" >
				...
				<div class="form-group">
			        ...
			        <input type="text" class="form-control" name="version" id="version"  value="<?php echo UNIONPAYVERSION ?>" required>
		        </div>
                      <div class="form-group">
		        ...
		        <div class="form-group">
			        ...
			        <input type="text" class="form-control" name="referer" value="http://www.xxx.com" >
		        </div>
