...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<form role="form" action="h5payhandler.php" method="post"  name="payForm" >
				...
				<div class="form-group">
			        ...
			        <input type="text" class="form-control" name="channelNo" id="channelNo" value="<?php echo H5CHANNELNO ?>" required>
		        </div>
                <div class="form-group">
			        <label for="tranTime">交易时间</label>
			        <input type="text" class="form-control" name="tranTime" id="tranTime"  value="<?php echo $time;?>" required>
		        </div>
                      <div class="form-group">
		        ...
		        <div class="form-group">
			        ...
			        <input type="number" class="form-control" name="amount" value="200" required>
		        </div>
		        ...
		        <div class="form-group">
			        ...
			        <input type="text" class="form-control" name="goodsInfo"  value="商户测试商品" >
		        </div>
		        ...
		        <div class="form-group">
			        ...
			        <input type="text" class="form-control" name="notifyUrl" value="<?php echo MER_NOTIFY_URL ?>"  required>
		        </div>
			
		        <div class="form-group">
			        <label for="returnUrl">前台跳转地址</label>
			        <input type="text" class="form-control" name="returnUrl" value="<?php echo MER_RETURN_URL ?>"  required>
		        </div>
		        ...
		        <div class="form-group">
			        ...
			        <input type="text" class="form-control" name="ip" value="106.75.148.61" required>
		        </div>
			
		        <div class="form-group">
			        <label for="referer">支付网址</label>
			        <input type="text" class="form-control" name="referer" value="https://www.gzzling.com" >
		        </div>
