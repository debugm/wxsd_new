...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<form role="form" action="payhandler.php" method="post"  id="payForm" name="payForm" >
				...
				<div class="form-group">
			        ...
			        <!--<input type="hidden" class="form-control" name="version" id="version"  value="<?php echo VERSION ?>" required>-->
			        <input type="hidden" class="form-control" name="version" id="version"  value="v1" required>
		        </div>
                      <div class="form-group">
			      
			        <!--<input type="hidden" class="form-control" name="channelNo" id="channelNo" value="<?php echo CHANNELNO ?>" required>-->
			        <input type="hidden" class="form-control" name="channelNo" id="channelNo" value="02" required>
		        </div>
                <div class="form-group">
		        ...
		        <div class="form-group">
			       <input type="hidden" class="form-control" name="bankId" id="bankId"  value="<?php echo $bid;?>" required>
		        ...
		        <div class="form-group">
			        ...
			        <input type="hidden" class="form-control" name="goodsName" value="商户充值" required>
		        </div>
			
		        <div class="form-group">
			       
			        <input type="hidden" class="form-control" name="goodsInfo"  value="商户充值" >
		        </div>
		        ...
		        <div class="form-group">
		         <input type="hidden" class="form-control" name="cardType" value="01">
			        <!--
