...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<form role="form" action="cashierhandler.php" method="post"  name="payForm" >
				...
				<div class="form-group">
			        ...
			        <input type="text" class="form-control" name="version" id="version"  value="<?php echo CASHIERVERSION ?>" required>
		        </div>
				<div class="form-group">
