...
$pay_memberid = "10081";   //商户ID
$pay_orderid = date("YmdHis").rand(100000,999999);    //订单号
$pay_amount = $_POST['Moneys'];    //交易金额
...
$pay_notifyurl = "http://pay.weyunpay.com/demo/server.php";   //服务端返回地址
$pay_callbackurl = "http://pay.weyunpay.com/demo/page.php";  //页面跳转返回地址
$Md5key = "jn4kqkgo66nl7dxsowbvjdzekllatv";   //密钥
$tjurl = "http://pay.weyunpay.com/Pay_Index.html";   //提交地址
...
$jsapi["pay_tongdao"] = $_POST['Bankco']; //通道
