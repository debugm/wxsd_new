				...
				for(t in obj){
				 ...
				 for(t in obj){
					$("#feilvbuttton"+t).unbind("click").click(function(e){
						...
						trafficval = $("#"+$(this).attr("trafficid")).val();
						
						$.ajax({
						type:'POST',
						url:ajaxurl,
						data:"userid="+id+"&payapiid="+payapiid+"&feilvval="+feilvval+"&fengdingval="+fengdingval+"&trafficval="+trafficval,
						dataType:'text',
						success:function(str){
							   if(str == "ok"){
									jAlert('修改成功！','提示信息');
