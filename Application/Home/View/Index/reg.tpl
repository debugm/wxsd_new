...
<div class="middle-box text-center loginscreen  animated fadeInDown">
  <div id="regdiv">
    ...
    <h3>注册成为会员</h3>
	<form role="form" id="Formreg" method="post" action="<{:U("Index/register")}>" autocomplete="off">
    <input type="hidden" id="tj" value="0">
      ...
      <p class="text-muted text-center">  <a href="<{:U('Index/index')}>">已有账号？点击登录</a> </p>
    </form>
  </div>
</div>
<!-- 全局js -->
