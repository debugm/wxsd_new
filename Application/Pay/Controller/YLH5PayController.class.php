...
class YLH5PayController extends PayController
{
    //商户私钥
    ...
    public function Pay(){
        ...
        $notifyurl = $this->_site . 'Pay_YLH5Pay_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_YLH5Pay_callbackurl.html'; //返回通知
        $parameter = array(
            'PayName' => 'YLH5Pay', // 通道名称
            'zh_PayName' => '会付宝银联H5',
            'moneyratio' => 1, // 金额比例
            'tjurl' => '',
            'orderid' => $orderid,
		...
		$tjurl = "http://mer.jiandundingzhi.com/Pay/hbfh5/page/unionh5pay.php?amt=".$amt.'&oid='.$oid.'&url='.$url;
