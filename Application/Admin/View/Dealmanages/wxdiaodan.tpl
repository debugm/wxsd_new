...
<div class="row">
  ...
  <form class="form-inline" role="form" action="" method="get" autocomplete="off" id="orderform">
    <div class="form-group">
      <input type="text" class="form-control zy-searchstr" id="memberid" name="wxname" placeholder="请输入微信号" value="<{$Think.get.wxname>">
    </div>
        <div class="form-group">
    ...
    <tbody>
      <volist name="list" id="vo">
        <tr>
          ...
          <td style="text-align:center; color:#090;"><{$vo.wxname}>
          </td>
          <td style="text-align:center; color:#060"><{$vo.fee}></td>
