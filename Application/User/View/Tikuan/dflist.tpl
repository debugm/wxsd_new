...
<title></title>
<css href="<{$siteurl}>Public/css/bootstrap.min.css" />
<css href="<{$siteurl}>Public/User/css/css.css" />
...
<js href="<{$siteurl}>Public/laydate/laydate.js" />
<js href="<{$siteurl}>Public/Admin/js/tklist.js" />
<js href="<{$siteurl}>Public/User/js/js.js" />
</head>
