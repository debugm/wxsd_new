...
<div style="margin-top: 20px;">
  <form class="form-inline" role="form">
    ...
    <button type="button" class="btn btn-primary zy-searchbutton" margin-left:20px;" id="ptshsearch"> <span class="glyphicon glyphicon-search"></span> <strong>搜索</strong> </button>&nbsp;&nbsp;
  </form>
</div>
  ...
  <table class="table table-bordered table-hover table-condensed table-responsive">
    ...
    <volist name="list" id="vo">
        <tr>
          ...
          <td style="text-align:center;"><{$vo.bankfenname}> <br> <{$vo.bankzhiname}></td>
          <td style="text-align:center;"><{$vo.bankfullname}></td>
          <td style="text-align:center;"><{$vo.banknumber}></td>
          <td style="text-align:center;"><{$vo.sheng}> <{$vo.shi}></td>
          ...
          <switch name="vo.status">
            ...
            <case value="3"><span style="color:#060;">失败</span></case>
            <default />
          </switch>
          </td>
        </tr>
