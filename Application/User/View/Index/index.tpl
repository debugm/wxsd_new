...
<div id="wrapper">
  ...
  <div id="page-wrapper" class="gray-bg dashbard-1">
    <div class="row border-bottom">
      <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-right">
          ...
          <li class="hidden-xs"> <i class="fa fa-user"></i> <{$Think.session.username}> </li>
    ...
    <div class="row J_mainContent" id="content-main">
      <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<{:U('Index/defaultindex')}>" frameborder="0" data-id="/User.html" seamless></iframe>
    </div>
    <div class="footer">
...
<!-- 自定义js -->
<script src="<{$siteurl}>Public/Front/js/hplus.js?v=4.1.0"></script>
