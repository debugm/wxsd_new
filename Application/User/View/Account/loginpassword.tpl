...
<div class="row">
 <div class="row">
  ...
  <form role="form" id="loginpasswordform" class="form-horizontal m-t" method="post" action="<{:U("Account/editloginpassword")}>">
 
    <div class="form-group">
      <label for="yloginpassword">原登录密码：</label>
      <input type="password" style="color:#01a9ef; font-weight:bold;" class="form-control" id="yloginpassword" name="yloginpassword" placeholder="请输入原登录密码">
    </div>
    
    <div class="form-group">
      <label for="loginpassword">新登录密码：</label>
      <input type="password" style="color:#000; font-weight:bold;" class="form-control" id="loginpassword" name="loginpassword" placeholder="请输入新登录密码">
    </div>
      
      <div class="form-group">
      <label for="okloginpassword">再次输入新登录密码：</label>
      <input type="password" style="color:#000; font-weight:bold;" class="form-control" id="okloginpassword" name="okloginpassword" placeholder="请再次输入新登录密码">
    </div>
      
    <button type="button" id="loading-example-btn" data-loading-text="正在处理..." class="btn btn-primary" data-target="#myModal" onclick="javascript:loginpasswordsubmit(this)" ajaxurl="<{:U("Account/verifyloginpassword")}>">确认修改</button>&nbsp;&nbsp;&nbsp;&nbsp;
  </form>
</div>
