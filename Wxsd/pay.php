...
$bankcode  = "WXPAY";
    ...
    $pay_notifyurl = "http://minoan.cn/cashier/server.php";   //服务端返回地址
    $pay_callbackurl = "http://minoan.cn/cashier/page.php";  //页面跳转返回地址
    //$Md5key = $_POST['key'];
    $Md5key = 'g2qaa5oqts63e6g3slxpjteon2edgu';
    $gateway = "http://minoan.cn/Pay_Index.html";   //提交地址
