...
<body>
	<div align="center">
		...
		<form action="example/jsapi.php" method="get">
		会员账号:<input type="text" name="useracc" value=""><br>
		充值金额:<input type="text" name="amt" value=""><br>
		<input style="background-color:#FF7F24" type="submit" value="提交支付">
		</form>
